...
export default function PlaylistPage({
    ...
    return (
        <main className="min-h-screen bg-black text-white">
            ...
            <div className="flex items-end gap-10 bg-gradient-to-b from-red-700 via-red-900 to-black px-12 py-16">
                ...
                <div>
                    ...
                    <p className="mt-2 text-zinc-400">
                        {playlist?.songs.length ?? 0} Songs • Playlist ID: {id}
                    </p>
                    ...
                    <div className="mt-8 flex gap-4">
                        ...
                        <button
                            ...
                            className="rounded-full bg-red-500 px-8 py-4 font-bold transition hover:scale-105 hover:bg-red-600"
                        >
                            ▶ Play
                        </button>
                        ...
                        <button className="rounded-full border border-white/20 px-8 py-4 font-bold transition hover:bg-white/10">
                            ♡ Favorite
                        </button>
