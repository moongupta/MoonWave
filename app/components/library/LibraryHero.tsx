...
export default function LibraryHero() {
  ...
  return (
    <section className="relative overflow-hidden rounded-[40px] border border-white/10 bg-black/30 p-10 backdrop-blur-3xl">
      {/* Ambient Glow */}
      <div className="absolute -top-32 left-20 h-105 w-105 rounded-full bg-violet-500/20 blur-[150px]" />

      <div className="absolute -right-24 bottom-0 h-105 w-105 rounded-full bg-pink-500/20 blur-[150px]" />
          ...
          {cards.map((card) => {
            ...
            return (
              <motion.div
                ...
                className="overflow-hidden rounded-[30px] border border-white/10 bg-white/5 p-6 shadow-[0_25px_80px_rgba(0,0,0,0.25)] backdrop-blur-2xl"
              >
                <div
                  className={`flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br ${card.color}`}
                >
                  <Icon
                    size={28}
